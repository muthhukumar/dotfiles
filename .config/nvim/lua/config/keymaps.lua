...
vim.keymap.set("n", "<C-P>",
               ':lua require("config.utils").toggle_go_test()<CR>', opts)

vim.keymap.set("n", "<Esc>", ":nohlsearch<CR>", opts)

-- My changes
-- Window split
vim.keymap.set("n", "<leader>wv", "<C-w>v") -- split window veritically
...
vim.keymap.set("n", "<leader>tn", ":tabnext<CR>") -- open new tab
vim.keymap.set("n", "<leader>tp", ":tabprev<CR>") -- open new tab
